...
const FAQ_DATA = [
  {
    ...
    answer:
      "A. 얼음은 친환경 활동을 통해 모을 수 있고 출석 체크를 통해 랜덤한 얼음을 받을 수 있습니다. 환경걸음, 식단 기록, 빙하 리포트, 오늘의 퀴즈 등 다양한 활동에 참여하고 얼음 거래소에서 사용 가능한 얼음을 적립해보세요.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "A. 랭킹은 주간, 전체는 매 시간마다 전체적으로 갱신되며, 지역 랭킹은 매일 자정에 갱신됩니다.",
  },
  {
    question: "Q. 출석 체크는 어떻게 하나요?",
    answer:
      "A. 하루에 한 번 이상 친환경 활동(환경걸음, 식단 기록, 빙하 리포트)을 기록하면 자동으로 출석 처리되고 마이페이지의 캘린더에서 출석 현황을 확인할 수 있습니다.",
  },
  {
    question: "Q. 각 친환경 활동의 탄소 절감량의 기준은 뭔가요?",
    answer:
      "A. 환경걸음은 자동차가 1km 주행시 배출하는 CO₂ 양(약 0.2kg)을 기준으로 도보·자전거는 100%, 대중교통은 50%로 산정됩니다. \n\n 식단 기록은 식사 1끼당 약 3.5kg의 CO₂ 배출을 기준으로 식당, 배달로 식사시 유통과 조리에 추가적인 탄소 배출이 발생하므로 가중치를 더해 산정됩니다.\n\n 빙하 리포트는 각 질문들을 탄소중립 실천포털과 GS칼텍스 미디어허브의 자료를 기준으로 산정됩니다.",
  },
  {
