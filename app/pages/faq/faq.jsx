...
const FAQ_DATA = [
  {
    question: "Q. 포인트는 어떻게 모으나요?",
    answer:
      "A. 포인트는 친환경 활동을 통해 모을 수 있고 출석 체크를 통해 랜덤 포인트를 받을 수 있습니다. 환경걸음, 식단 기록, 빙하 리포트, 오늘의 퀴즈 등 다양한 활동에 참여하고 포인트를 적립해보세요.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "A. 마이페이지의 캘린더에서 출석 현황을 확인할 수 있습니다. 하루에 한 번 이상 친환경 활동(환경걸음, 식단 기록, 빙하 리포트)을 기록하면 자동으로 출석 처리됩니다.",
  },
  {
